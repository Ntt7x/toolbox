...
const MODULE_LABELS: Record<string, string> = {
  "cb-rate": "央行利率分析",
  "treasury-fx": "国债汇率分析",
  "watchlist.fundamental": "自选股·财报分析",
  "watchlist.reason-optimize": "自选股·理由优化",
  "watchlist.extend": "自选股·延续思考",
  "watchlist.import": "自选股·Chat导入",
  "watchlist.logic-review": "自选股·逻辑复核",
  "reverse-repo.daily": "逆回购·每日探查",
  "reverse-repo.monthly-update": "逆回购·月度更新",
  "medical-kb.ask": "医学知识库·问答",
  "medical-kb.import": "医学知识库·导入",
  "knowledge.ask": "知识库·问答",
  "knowledge.import": "知识库·导入",
  "knowledge-hub.ask": "知识库中心·问答",
  "knowledge-hub.import": "知识库中心·导入",
  "knowledge-hub.gen-template": "知识库中心·模板生成",
  "experiment.framework": "实验·投资框架",
  "experiment.ec": "实验·ec 研判",
  "experiment.ec.collect": "实验·ec 数据采集",
  "experiment.bmpi": "实验·BMPI 研判",
  "experiment.bmpi.collect": "实验·BMPI 数据采集",
  "watchlist.fundamental.session": "自选股·财报分析(会话)",
  "zhihu.auth": "知乎爬虫·授权",
  "zhihu.crawler": "知乎爬虫·内容抓取",
